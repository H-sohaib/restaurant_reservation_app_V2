<x-app-layout>
    ...
    <div class="container w-full px-5 py-6 mx-auto">
        <div class="flex items-center h-4/5 bg-gray-50">
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            ...
                            <form method="POST" action="{{ route('make_reservation.step_two.store') }}">
                                @csrf
                                <div class="sm:col-span-6 pt-5">
                                    <label for="status" class="block text-sm font-medium text-gray-700">Table</label>
                                    <div class="mt-1">
                                        <select name="table_id" class="form-multiselect block w-full mt-1">
                                            @foreach ($tables as $table)
                                                {{-- @if ($table->guest >= $reservation->guest) --}}
                                ...
                                <div class="mt-6 p-4 flex justify-between">
                                    <a href="{{ route('make_reservation.step_one.create') }}"
